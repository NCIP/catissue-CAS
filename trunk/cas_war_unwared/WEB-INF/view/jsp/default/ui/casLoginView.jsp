...
<table width="100%" height="99%" border="1" cellspacing="0" cellpadding="0">
	<tr height="10%">
		<td>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									...
									<a
										...
										height="12" border="0" hspace="2" vspace="0"><spring:message code="app.home" /></a>
									<a
										...
										height="12" border="0" hspace="2" vspace="0"><spring:message code="app.reportedProblems" /></a>&nbsp; <a
										...
										width="16" height="12" hspace="3" vspace="0" border="0" /><spring:message code="app.contactUs" /></a>&nbsp;<a href="/catissuecore/SummaryPage.do"
										class="white"><img
										src="images/uIEnhancementImages/ic_summary.gif" alt="Summary"
										width="10" height="10" hspace="4" vspace="0" border="0" /><spring:message code="app.summary" /></a>&nbsp;&nbsp;</td>
								</tr>
							</table>
							</td>
						</tr>
		...
		-->
			<table width="100%" border="0" cellspacing="0" cellpadding="0"  height="100%">
				<tr height="100%">
					...
					<a name="content" style="height:100%"/>
						...
						<tr>
											...
											<table border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td nowrap="nowrap" class="td_table_head"><span
														class="wh_ar_b"><spring:message code="app.quickLinks" /></span></td>
													<td><img
											...
											<table width="98%" border="0" cellspacing="0" cellpadding="6">
												<tr>
													<td><a href="https://cabig.nci.nih.gov/" target="_blank"
														class="view"><span class="wh_ar_b"></span><spring:message code="app.cabigHome" /></a>
												</tr>
												<tr>

													<td><a href="http://ncicb.nci.nih.gov/" target="_blank"
														class="view"><span class="wh_ar_b"></span><spring:message code="app.ncicbHome" /></a></td>
												</tr>
												...
												<tr>
													<td><a
														...
														class="view"><span class="wh_ar_b"></span><spring:message code="app.privacyNotice" /></a></td>
												</tr>
												<tr>
													<td><a
														href="/catissuecore/Disclaimer.do?PAGE_TITLE_KEY=app.disclaimer&FILE_NAME_KEY=app.disclaimer.file"
														class="view"><span class="wh_ar_b"></span><spring:message code="app.disclaimer" /></a></td>

												</tr>
													<tr>
														<td><a
															href="/catissuecore/Accessibility.do?PAGE_TITLE_KEY=app.accessibility&FILE_NAME_KEY=app.accessibility.file"
															class="view"><span class="wh_ar_b"></span><spring:message code="app.accessibility" /></a></td>
													</tr>
													<tr>
														<td style="padding-bottom: 16px;"><a
															href="/catissuecore/RedirectToHelp.do" class="view"><span
															class="wh_ar_b"></span><spring:message code="app.help" /></a></td>
													</tr>
											</table>
											</td>
										</tr>
							...
							<table width="95%" border="0" cellpadding="0" cellspacing="0">
										...
										<tr class="wh_ar_b">
											...
											<table border="0" cellpadding="0" cellspacing="0">
												<tr>
													...
													<td nowrap="nowrap" class="td_table_head"><span
														class="wh_ar_b"><spring:message code="app.loginMessage" /></span></td>
													<td><img
														src="images/uIEnhancementImages/table_title_corner.gif"
														alt="Title" width="31" height="24" /></td>
												</tr>
												...
												<form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
													...
													<table width="98%" border="0" cellpadding="4" cellspacing="0">
														...
														<tr>
															...
															<table border="0" cellspacing="0" cellpadding="0">
																<tr>
																	<td><input class="blue_ar_b" name="submit" accesskey="l" value="<spring:message code="screen.welcome.button.login" />" tabindex="4" type="submit" /></td>
								...
								<tr>
									<td background="images/uIEnhancementImages/shadow_down.gif"></td>
									<td><img src="images/uIEnhancementImages/shadow_corner.gif"
										alt="Shadow Corner" width="5" height="2" /></td>
								</tr>
							</table>
