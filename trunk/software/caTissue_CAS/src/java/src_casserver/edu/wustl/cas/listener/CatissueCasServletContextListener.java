...
package edu.wustl.cas.listener;
 ...
 */
public final class CatissueCasServletContextListener implements ServletContextListener
{
	...
	public void contextInitialized(final ServletContextEvent sce)
	{
		try
		{
			log.info("Initializing CAS application");
			...
			log.info("Initializing CAS application complete");
		}
		catch (Throwable t)
		{
			/*
